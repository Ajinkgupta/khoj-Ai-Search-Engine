...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($xml) {
        ...
        foreach ($items as $item) {
            ...
            $sql = "INSERT INTO news_hindi (guid, title, link, pubDate, thumbnail_url, description, content_encoded) VALUES ('$guid', '$title', '$link', '$pubDate', '$thumbnail_url', '$description', '$contentEncoded')";
...
<html>
<head>
    <title>Hindi News Parser</title>
</head>
<body>
    <h1>Hindi News Parse</h1>
    <form method="post">
